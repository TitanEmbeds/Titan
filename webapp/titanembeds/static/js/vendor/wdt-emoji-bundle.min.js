...
flags.innerHTML=self.emoji.replace_colons(':waving_white_flag:');var custom=self.popup.querySelector('[data-group-name="Server Emoji"]');if(custom)
...
var customEmotes=sections["Server Emoji"];for(var i=0;i<customEmotes.length;i++){for(var j=0;j<recentEmotes.length;j++){if(customEmotes[i].short_name==recentEmotes[j].short_name){sections["Recent"].push(customEmotes[i]);}}}
